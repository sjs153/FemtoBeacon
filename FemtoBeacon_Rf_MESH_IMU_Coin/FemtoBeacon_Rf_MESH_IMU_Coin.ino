...
void handleSensors()
{
  ...
  */
  ...
  // ...Yaw
  ++bufferIndex;
  dtostrf(raw_values[0], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;

  // ...Pitch
  ++bufferIndex;
  dtostrf(raw_values[1], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;

  // ...Roll
  ++bufferIndex;
  dtostrf(raw_values[2], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;

  // Euler 1
  ++bufferIndex;
  dtostrf(raw_values[3], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;
  // Euler 2
  ++bufferIndex;
  dtostrf(raw_values[4], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;
  // Euler 3
  ++bufferIndex;
  dtostrf(raw_values[5], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;
  
    // data7
  ++bufferIndex;
  dtostrf(raw_values[6], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;
    // data8
  ++bufferIndex;
  dtostrf(raw_values[7], 8, 2, &bufferData[bufferIndex]);
  bufferIndex += 8;
  bufferData[bufferIndex] = delimeter;
    // data9
  ++bufferIndex;
  dtostrf(raw_values[8], 8, 2, &bufferData[bufferIndex]);
  //bufferIndex += 8;
  //bufferData[bufferIndex] = delimeter;
  /*
    // BaroAlt
